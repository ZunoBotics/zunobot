...
class RobotApiClient(private val baseUrl: String) {
     ...
     */
    suspend fun move(direction: String, duration: Float): Response {
     ...
     */
    suspend fun turn(direction: String, angle: Int): Response {
        val json = JSONObject().apply {
            put("direction", direction)
            put("angle", angle)
        }
     ...
     */
    suspend fun moveHead(position: String): Response {
        val json = JSONObject().apply {
     ...
     */
    suspend fun lookAround(): Response {
        val json = JSONObject()
        val body = json.toString().toRequestBody(JSON_MEDIA_TYPE)
     ...
     */
    suspend fun greeting(language: String = "auto"): Response {
        val json = JSONObject().apply {
     ...
     */
    suspend fun startDetection(): Response {
        val request = Request.Builder()
     ...
     */
    suspend fun stopDetection(): Response {
        val request = Request.Builder()
     ...
     */
    suspend fun getDetectionStatus(): Response {
        val request = Request.Builder()
